...
TLP is a modular framework for Time parameterized Linear Programming problems for use in energy market modelling. It is written in the Julia programming language.
