...
"""
getisoyearstart(t::DateTime) =
    t +
    Millisecond(3600000 * 24 * (8 - 7 * week(t) - dayofweek(t)) - Dates.value(t) % 86400000)
...
function getsimilardatetime(t::DateTime, isoyear::Int)
    getisoyearstart(isoyear) +
    Millisecond(3600000 * 24 * (7 * week(t) + dayofweek(t) - 8) + Dates.value(t) % 86400000)
end
