...
setconcoeff!(p::FixBreach_Prob, con::Id, var::Id, ci::Int, vi::Int, value::Float64) =
    setconcoeff!(p.prob, con, var, ci, vi, value)
...
setobjcoeff!(p::FixBreach_Prob, var::Id, i::Int, value::Float64) =
    setobjcoeff!(p.prob, var, i, value)
setrhsterm!(p::FixBreach_Prob, con::Id, trait::Id, i::Int, value::Float64) =
    setrhsterm!(p.prob, con, trait, i, value)
...
getrhsterm(p::FixBreach_Prob, con::Id, trait::Id, i::Int) =
    getrhsterm(p.prob, con, trait, i)
hasrhsterm(p::FixBreach_Prob, con::Id, trait::Id, i::Int) =
    hasrhsterm(p.prob, con, trait, i)
getlb(p::FixBreach_Prob, var::Id, i::Int) = getlb(p.prob, var, i)
getub(p::FixBreach_Prob, var::Id, i::Int) = getub(p.prob, var, i)
getconcoeff(p::FixBreach_Prob, con::Id, var::Id, ci::Int, vi::Int) =
    getconcoeff(p.prob, con, var, ci, vi)
getobjcoeff(p::FixBreach_Prob, var::Id, i::Int) = getobjcoeff(p.prob, var, i)
getfixvardual(p::FixBreach_Prob, varid::Id, varix::Int) =
    getfixvardual(p.prob, varid, varix)
fix!(p::FixBreach_Prob, varid::Id, varix::Int, value::Float64) =
    fix!(p.prob, varid, varix, value)
