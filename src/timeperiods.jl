...
function includeSimulationTimePeriod!(
    ::Dict,
    lowlevel::Dict,
    elkey::ElementKey,
    value::Dict,
...
INCLUDEELEMENT[TypeKey(TIMEPERIOD_CONCEPT, "ScenarioTimePeriod")] =
    includeScenarioTimePeriod!
INCLUDEELEMENT[TypeKey(TIMEPERIOD_CONCEPT, "SimulationTimePeriod")] =
    includeSimulationTimePeriod!
