function get_dummy_data(; profilepath = nothing)
    ...
    elements_bio = [
        ...
        DataElement(
            ...
            "MWToGWhSeriesParam",
            "CapBioGER",
            Dict{Any,Any}("Level" => 5000.0, "Profile" => 1.0),
        ),
    ]
    ...
    elements_coal = [
        ...
        DataElement(
            ...
            "MWToGWhSeriesParam",
            "CapCoalGER",
            Dict{Any,Any}("Level" => 150000.0, "Profile" => 1.0),
        ),
        DataElement(
            "Cost",
            "CostTerm",
    ...
    elements_power_balance = [
        ...
        DataElement(
            ...
            "MWToGWhSeriesParam",
            "DemandGER",
            Dict("Level" => "LevelDemandGER", "Profile" => "ProfileDemandGER"),
        ),
        DataElement(
            "TimeValues",
            "VectorTimeValues",
            "LevelDemandGER",
            Dict("Vector" => [50000.0, 55000.0]),
        ),
        DataElement(
            "TimeVector",
            "InfiniteTimeVector",
            "LevelDemandGER",
            Dict("TimeIndex" => "DataLevelsTimeIndex", "TimeValues" => "LevelDemandGER"),
        ),
        DataElement(
            "TimeIndex",
            "VectorTimeIndex",
    ...
    push!(
        ...
        DataElement(
            ...
            "ProfileDemandGER",
            Dict(
                TIMEVALUES_CONCEPT => "ProfileDemandGER",
                TIMEINDEX_CONCEPT => "ProfilesTimeIndex",
            ),
        ),
    )
