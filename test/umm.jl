module TestUMMSeriesParam

using TuLiPa, JSON, Dates, Test

function run_tests()
    horizon = SequentialHorizon(40, Day(1))
    obj_test = PositiveCapacity(
        Id("Capacity", "Capacity_test"),
        UMMSeriesParam(
    ...
    @test TuLiPa._get_new_profile_start(obj_test.param, datatime, scenariotime)[1] ==
          DateTime("1980-01-03T00:00:00")
    ...
    pt = PhaseinTwoTime(
        ...
        DateTime("1980-01-01T12:00:00"),
        DateTime("1985-01-01T12:00:00"),
        phaseinvector,
    )
    horizon = SequentialHorizon(40, Day(1))
    t = 2
